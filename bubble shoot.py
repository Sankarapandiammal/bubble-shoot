...
class Bubble:
    ...
    def update(self):
        ...
        if self.pos[0] <= BUBBLE_RADIUS or sel.pos >=WIDTH - BUBBLE_RADIUS:
...
def draw(canvas):
    ...
    # create frames and register handlers
    frame = pygame.create_frame("Bubble Shooter", WIDTH, HEIGHT)
    frame.set_keydown_handler(keyydown)
